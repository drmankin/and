---
title: "Practical 1: Setup and Revision"
...
* Under Files:
  ...
  + Save the dataset(s) in `analysing_data` > `data`
...
* Quiz topic: same the practice quiz
  + Revise practicals and tutorials from PAAS
  + A few NEW questions from Dr Mankin's Week 1 lecture
